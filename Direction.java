 ...
 * Direction.java
 * 
 * A class for representing the direction of a line segment. The xDir 
 * represents the multiplier for the x-component of the line and the yDir
 * represents the multiplier for the y-component of the line. The sum
 * of the squares of xDir and yDir will always equal 1. Includes two 
 * constructors and getters and setters for the xDir and yDir variables.
 * The class also include two methods turnLeft and turnRight for turning
...
public class Direction 
{
	...
	/**
	 * A no-args constructor for creating a Direction object of 
	 * a horizontal line pointing towards the positive x-direction.
	 */
	public Direction()
	{
		xDir = 1.0;
	...
	/**
	 * A two-args constructor for creating a Direction object, The
	 * parameters represent the x-component and y-component of the
	 * direction.
